...
from modules.briefings.context import assemble_briefing_context as _assemble_briefing_context
...
# _assemble_briefing_context moved to modules/briefings/context.py (Item #16) —
# shared with the weekly briefing generator; imported above under its old name.
